...
class Subdomain_Scanner():
    ...
    def _subdomain_scanner(cls, mutations=False, CONSOLE=console, verbose=False):
        ...
        try:
            ...
            with Variables.LOCK: Variables.panel_text = f"Target:[{c5}] {sub}.*[/{c5}]  -  Enumeration:[{c5}] {cls.scanned}/{cls.total}[/{c5}]  -  Max_Workers:[{c5}] {Variables.max_threads}[/{c5}]  -  Wordlist:[{c5}] {Variables.s_name}[/{c5}]  -  Errors:[{c5}] {Variables.errors}[/{c5}]"
